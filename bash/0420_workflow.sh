...
EXPERIMENT_DESC="实验描述：0420 policy train with sarm rabc subtasks inference"
DATE="0420_workflow"
...
setsid nohup \
    ...
    --output-path="datasets/openarm_data_260306_260330_sft_style_hg/sarm_progress_subtasks_0417.parquet" \
    --output-dir="outputs/${DATE}/${STAGE2}_${STAGE2_TAG}_${TIMESTAMP}" \
    >> "${LOG_FILE}" 2>&1 &

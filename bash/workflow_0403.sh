...
EXPERIMENT_DESC="实验描述：value01 实验的 0403 "
DATE="0403_value01"
STAGE1="value_train" 
STAGE1_TAG="value01-bs8-80k"

STAGE2="value_infer" 
STAGE2_TAG="value01-bs8-80k"
...
VALUE_INFER_TAG="value01-bs8-80k"
...
setsid nohup \
    ...
    --dataset.root="outputs/merge_rollout_0_20260330_203044" \
    --inference.checkpoint_path="outputs/${DATE}/${STAGE1}_${STAGE1_TAG}_${TIMESTAMP}/checkpoints/080000/pretrained_model" \

...
EXPERIMENT_DESC="实验描述：sarm train 0423,在datasets/openarm_data_260306_260319_sft_with_subtask上训练 带 subtask 训练测试 rule_based"
DATE="0423_sarm_train_subtasks_rule"
STAGE1="sarm_train" 
STAGE1_TAG="0423_sarm_subtasks_rule"

source /mnt/data/syk/.bashrc
conda activate evo-rl


export LEROBOT_LOG_LEVEL="DEBUG"  #  INFO or DEBUG 

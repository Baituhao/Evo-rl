...
EXPERIMENT_DESC="实验描述：sarm train 0417,在datasets/openarm_data_260306_260319_sft_with_subtask上训练 带 subtask 训练测试"
DATE="0417_sarm"
STAGE1="sarm_train" 
...
echo "====================================================================================================" >> "${LOG_FILE}"
    ...
    # --num_processes=8 \
       ...
       # --config_path="bash/config/0417_sarm_train_with_subtasks.json" \
    # --batch_size=8 \
    ...
    # --dataset.root="/mnt/oss/shenjian/datasets_with_subtask/openarm_data_260306_260319_sft_with_subtask" \
...
setsid nohup \
    ...
    --config_path="bash/config/sarm_train_with_subtasks_default_config.json" \
    --batch_size=8 \
    --policy.image_downsample_antialias=true \
    --policy.image_downsample_size="[480, 640]" \
    --output_dir="outputs/${DATE}/${STAGE1}_${STAGE1_TAG}_${TIMESTAMP}" \

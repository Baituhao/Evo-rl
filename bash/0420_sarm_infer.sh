...
EXPERIMENT_DESC="实验描述：sarm-0410 infer on dataset datasets/openarm_data_260306_260319_sft,"
DATE="0420_sarm_infer"
STAGE2="sarm_infer" 
...
setsid nohup \
    ...
    --output-path="datasets/openarm_data_260306_260319_sft/sarm_progress_0410.parquet" \
    >> "${LOG_FILE}" 2>&1 &

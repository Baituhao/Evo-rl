...
EXPERIMENT_DESC="实验描述：value01 实验的 0403 的修正，之前value infer 存在问题，现在修复后重新推 "
DATE="0403_value01_rectify"
STAGE1="value_train" 
...
STAGE3="policy_train" 
STAGE3_TAG="0403-rectify-bs64-10k"

STAGE4="policy_rollout" 
STAGE4_TAG="0403-rectify-bs64-10k"
...
setsid nohup \
    ...
    --dataset.root="outputs/merge_rollout_0_20260330_203044" \
    --inference.checkpoint_path="outputs/0403_value01/value_train_value01-bs8-80k_20260403_212119/checkpoints/080000/pretrained_model" \

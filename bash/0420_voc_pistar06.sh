...
EXPERIMENT_DESC="实验描述：voc 计算 pistar06 voc 0424"
DATE="0424_voc_pistar06"
STAGE1="voc_compute_hg_500" 
STAGE1_TAG="pistar06_0410"
...
setsid nohup \
    ...
    --progress-parquet "datasets/1_openarm_data_260306_260330_sft_style_hg/data/chunk-000/file-000.parquet" \

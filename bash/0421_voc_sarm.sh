...
EXPERIMENT_DESC="实验描述：voc 计算 sarm 0410, 1400-1899 episodes"
DATE="0421_voc_sarm"
STAGE1="voc_compute" 
...
setsid nohup \
    ...
    --progress-parquet "datasets/openarm_data_260306_260319_sft_style_hg/sarm_progress_1400_1899.parquet" \

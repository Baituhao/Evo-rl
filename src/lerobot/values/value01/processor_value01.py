...
VALUE01_IMAGES_KEY = "observation.value01.images"
VALUE01_IMAGE_MASK_KEY = "observation.value01.image_attention_mask"
...
@ProcessorStepRegistry.register(name="value01_prepare_task_prompt")
@dataclass
class Value01PrepareTaskPromptProcessorStep(ProcessorStep):
    task_key: str = "task"
...
@ProcessorStepRegistry.register(name="value01_prepare_images")
@dataclass
class Value01PrepareImagesProcessorStep(ProcessorStep):
    ...
    def __call__(self, transition: EnvTransition) -> EnvTransition:
        ...
        observation[VALUE01_IMAGES_KEY] = images.to(dtype=torch.float32)
        observation[VALUE01_IMAGE_MASK_KEY] = image_attention_mask.to(dtype=torch.bool)
...
def make_value01_pre_post_processors(
    ...
    input_steps: list[ProcessorStep] = [
        ...
        Value01PrepareTaskPromptProcessorStep(
        ...
        Value01PrepareImagesProcessorStep(camera_features=camera_features),
